...
namespace HomeworkPortal.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(ILogger<HomeController> logger, LessonRepository lessonRepository, IMapper mapper, IConfiguration config, INotyfService notyf, IFileProvider fileProvider, UserManager<AppUser> userManager, RoleManager<AppRole> roleManager, SignInManager<AppUser> signInManager)
        {
            _logger = logger;
        ...
        public async Task<IActionResult> Index()
        {
            ...
            lessons = lessons.Where(s => s.IsActive == true).ToList();
