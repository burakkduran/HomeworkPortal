...
namespace HomeworkPortal.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(ILogger<HomeController> logger, LessonRepository lessonRepository, IMapper mapper, UserRepository userRepository, IConfiguration config, INotyfService notyf, IFileProvider fileProvider)
        {
            _logger = logger;
